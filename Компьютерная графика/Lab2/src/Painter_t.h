...
public:
	...
	void Draw(Frame& frame)
	{
		...
		if (MAIN_TASK) {
			...
			if (starDrawMode == DrawMode::SECTOR) {
				frame.Triangle(star[7].x, star[7].y, star[0].x, star[0].y, star[1].x, star[1].y, sectorInterpolator);
				frame.Triangle(star[1].x, star[1].y, star[2].x, star[2].y, star[7].x, star[7].y, sectorInterpolator);
				frame.Triangle(star[3].x, star[3].y, star[4].x, star[4].y, star[5].x, star[5].y, sectorInterpolator);
				frame.Triangle(star[5].x, star[5].y, star[6].x, star[6].y, star[3].x, star[3].y, sectorInterpolator);
			}
				...
				frame.Triangle(star[1].x, star[1].y, star[2].x, star[2].y, star[7].x, star[7].y, radialInterpolator);
				frame.Triangle(star[3].x, star[3].y, star[4].x, star[4].y, star[5].x, star[5].y, radialInterpolator);
				frame.Triangle(star[5].x, star[5].y, star[6].x, star[6].y, star[3].x, star[3].y, radialInterpolator);
			}
				...
				frame.Triangle(star[1].x, star[1].y, star[2].x, star[2].y, star[7].x, star[7].y, triangleInterpolator);
				frame.Triangle(star[3].x, star[3].y, star[4].x, star[4].y, star[5].x, star[5].y, triangleInterpolator);
				frame.Triangle(star[5].x, star[5].y, star[6].x, star[6].y, star[3].x, star[3].y, triangleInterpolator);
			}
		}
		else {
			float x0 = 0, y0 = 0, x1 = frame.width, y1 = frame.height;
